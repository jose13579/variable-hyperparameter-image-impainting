...
model_path=trained_models/places/places_proposal_inpainting_proposal_seed_$set_seed/gen_00050.pth
output_path_model=test_trained_models/trained_places_inpainting_proposal_seed_$set_seed
...
input_path_images=/data/places365/val_256
