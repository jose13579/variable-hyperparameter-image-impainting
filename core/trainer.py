...
from core.loss import AdversarialLoss, StyleLoss, PerceptualLoss
...
class Trainer():
    ...
    def _train_epoch(self, pbar):
        ...
        for images, masks in self.train_loader:
            ...
            real_vid_feat = self.netD(images)
            ...
            if self.config['global_rank'] == 0:
                ...
                pbar.set_description((
                    f"d: {dis_loss.item():.3f}; g: {gan_loss.item():.3f}; perceptual: {perceptual_loss.item():.3f}; style: {style_loss.item():.3f};  "
